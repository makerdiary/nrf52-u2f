...
#define U2FHID_FW_VERSION_MAJOR 1       // Major version number
#define U2FHID_FW_VERSION_MINOR 0       // Minor version number
#define U2FHID_FW_VERSION_BUILD 0       // Build version number
